...
document.body.addEventListener('click', (event)=>{
    if (event.target.classList[0] === 'buyTicketBtns') event.target.addEventListener("click", ()=>{
...
},{"./style.scss":"81Z0h","notyf":"fR5BU","notyf/notyf.min.css":"bpCRw","sweetalert2":"aLJx9","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"81Z0h":[function() {},{}],"fR5BU":[function(require,module,exports,__globalThis) {
/*! *****************************************************************************
...
},{}],"bpCRw":[function() {},{}],"aLJx9":[function(require,module,exports,__globalThis) {
/*!
...
`;
   ...
   */ const applyNumericalStyle = (elem, property, value)=>{
        ...
        if (value || parseInt(`${value}`) === 0) elem.style.setProperty(property, typeof value === 'number' ? `${value}px` : /** @type {string} */ value);
...
`;
   ...
   */ const handlePopupAnimation = (instance, popup, innerParams)=>{
        ...
        else if (container) // Otherwise, remove immediately
   ...
   */ const deny = (instance, value)=>{
        ...
        if (innerParams.preDeny) {
            ...
            preDenyPromise.then((preDenyValue)=>{
                ...
                } else instance.close(/** @type SweetAlertResult */ {
                    isDenied: true,
   ...
   */ const showRelatedButton = (domCache)=>{
        ...
        if (buttonToReplace.length) show(/** @type {HTMLElement} */ buttonToReplace[0], 'inline-block');
   ...
   */ const bodyClickListener = (event)=>{
        for(let el = /** @type {any} */ event.target; el && el !== document; el = el.parentNode)for(const attr in clickHandlers){
   ...
   */ const getSwalParams = (templateContent)=>{
        ...
        swalParams.forEach((param)=>{
            ...
            if (paramName in defaultParams && typeof defaultParams[/** @type {keyof typeof defaultParams} */ paramName] === 'boolean') result[paramName] = value !== 'false';
            else if (paramName in defaultParams && typeof defaultParams[/** @type {keyof typeof defaultParams} */ paramName] === 'object') result[paramName] = JSON.parse(value);
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequire2c45", {})
